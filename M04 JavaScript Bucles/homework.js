...
function operadoresLogicos(num1, num2, num3) {
    ...
    if (0 > num2 || 0 > num3 || num1 < 0) return 'Hay negativos'
    if (num3 > num2 && num3 > num1) return num3 + 1
    if (0 === num2 && 0 === num3 && num1 === 0) return 'Error'
    return false
}
...
function esPrimo(num) {
    ...
    if (num > 1) {
        var divisor = 2
        while (divisor * divisor <= num && respuesta) {
            respuesta = respuesta && num % divisor !== 0
            divisor = divisor + 1
        }
    } else {
        respuesta = false
